...
export const App: React.FC = (props) => (
  <div>
    <div className="contents">
      Korea Univ. Amateur Astronomical Association
      <p>
        <h3>별헤는밤</h3>
        <h4>윤동주</h4>
      </p>
      <p>계절이 지나가는 하늘에는 가을로 가득 차 있습니다.</p>
      <p>나는 아무 걱정도 없이 가을 속의 별들을 다 헬 듯합니다.</p>
      <p>
      ...
      <p>이네들은 너무나 멀리 있습니다. 별이 아스라이 멀듯이.</p>
      <p>어머님, 그리고 당신은 멀리 북간도에 계십니다.</p>
      <p>
        나는 무엇인지 그리워 이 많은 별빛이 내린 언덕 위에 내 이름자를 써 보고
        흙으로 덮어 버리었습니다.
      </p>
      <p>딴은 밤을 새워 우는 벌레는 부끄러운 이름을 슬퍼하는 까닭입니다.</p>
      <p>
