...
exports.convertAllEquatorial = exports.azaltToCatesian = exports.equatorialToHorizontal = exports.getLocalSidereal = exports.getLocalGeographic = void 0;
...
var getLocalGeographic = function () { return __awaiter(void 0, void 0, void 0, function () {
    var endpoint, base;
...
exports.getLocalGeographic = getLocalGeographic;
// getLocalSidereal : long -> LST
var getLocalSidereal = function (longitude) {
    var now = new Date();
...
exports.getLocalSidereal = getLocalSidereal;
// equatorialToHorizontal : lat -> LST -> star -> {az, alt}
var equatorialToHorizontal = function (lat, LST, star) {
    /*
     * ra : hour
     * dec : -90 ~ +90
     * lat : -90 ~ +90
...
exports.equatorialToHorizontal = equatorialToHorizontal;
// azaltToCatesian : az -> alt -> {x, y, z}
var azaltToCatesian = function (az, alt) {
    var pi = (-az + 360) % 360;
    var theta = -alt + 90;
...
exports.azaltToCatesian = azaltToCatesian;
// azaltToCatesian : star* -> star*
var convertAllEquatorial = function (stars, geo) {
    return stars.map(function (star) {
        return (0, exports.equatorialToHorizontal)(geo.lat, (0, exports.getLocalSidereal)(geo.lon), star);
    });
};
exports.convertAllEquatorial = convertAllEquatorial;
