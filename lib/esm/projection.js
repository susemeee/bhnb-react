...
export var starToRandomMap = function (stars) {
...
export var starToCelestialMap = function (stars) {
    return stars.map(function (star) {
        var az = star.az;
        var alt = star.alt;
        var mag = star.mag;
...
export var starToGroundMap = function (stars, fov) {
    if (fov === void 0) { fov = "N"; }
    return stars.map(function (star) {
        var az = star.az;
        var alt = star.alt;
        var mag = star.mag;
        var _a = azaltToCatesian(az, alt), x = _a.x, y = _a.y, z = _a.z;
